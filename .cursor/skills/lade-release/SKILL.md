...
The tag workflow copies the `CHANGELOG.md` section into the GitHub release. Write that section before tagging. The published body keeps `## [X.Y.Z]` without the date, the section text, and the compare link.
