...
"psql .*":
  DB_PORT:
    alice: kubectl://k8s-a.example.com:6443/example-cluster/dev/service/postgres/5432
    ".": kubectl://k8s-b.example.com:6443/example-cluster/dev/service/postgres/5432
```
