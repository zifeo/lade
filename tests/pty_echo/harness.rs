...
pub const OSC_RESPONSE: &[u8] = b"\x1b]11;rgb:1f1f/2424/2828\x1b\\";
pub const CPR_RESPONSE: &[u8] = b"\x1b[37;1R";

pub const OSC_MARKER: &[u8] = b"rgb:1f1f/2424/2828";
pub const CPR_MARKER: &[u8] = b";1R";

pub const CHILD_READY: &str = "__lade_pty_ready__";
...
pub fn spawn_with(lade_bin: &Path, project: &Path, inject_cmd: &str) -> Harness {
    let size = Winsize {
        ws_row: 40,
        ws_col: 120,
        ws_xpixel: 0,
...
pub fn drive(lade_bin: &Path, project: &Path) -> Vec<u8> {
    let Harness {
        master,
        slave,
        mut child,
...
pub fn write_redactor_yml(project: &Path, secret_value: &str) {
